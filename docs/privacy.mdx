...
- **Stripe:** If you subscribe to EyeRhythm Premium, we use Stripe to process payments. Stripe collects and processes payment information (such as your credit card number) directly. We never have access to your full payment card details. We only receive and store a Stripe customer ID and subscription ID to manage your subscription status. For more information about how Stripe handles your data, please see [Stripe's Privacy Policy](https://stripe.com/privacy).
...
**Data Retention by Subscription Tier:**
- **Free tier:** Session data and blink patterns are retained for 7 days. Data older than 7 days is automatically deleted.
- **Premium tier:** Session data and blink patterns are retained for 365 days. Data older than 365 days is automatically deleted.
- **Account information:** Retained for as long as you maintain an active account.

When you downgrade from Premium to Free, your data retention period changes accordingly, and data older than 7 days will be deleted.
